...
public class ModuleConstants {
    ...
    public static class BottomRight {
        ...
        public static final double OFFSET = 42.7148;
    ...
    public static class BottomLeft {
        ...
        public static final double OFFSET = 35.6836;
